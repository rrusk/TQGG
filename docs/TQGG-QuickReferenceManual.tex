...
\begin{description}
\item[Boundary Orientation] All boundaries orientation are checked. Clockwise boundaries are then displayed in \emph{red}, while counter-clockwise boundaries are display in \emp{green}
